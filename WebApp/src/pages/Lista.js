...
const Lista = () => {
    ...
    return (
        <div className="contenedor">
            ...
            <p>Total de libros registrados:<b> {totalLibros}</b></p>
            ...
            {busqueda && <p>Coincidencias de búsqueda: <b>{coincidenciasBusqueda ? coincidenciasBusqueda : 'No hay coincidencias'}</b></p>}
            {loading ? (
                <p>Cargando libros...</p>
            ) : error ? (
                <p>{error}</p>
