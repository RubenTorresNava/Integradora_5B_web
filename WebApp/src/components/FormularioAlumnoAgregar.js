      ...
      <div className="row justify-content-center">
        <div className="col-12 col-md-6">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              <label htmlFor="numeroControl" className="form-label titulo">
                Numero de Control
              </label>
              <input
                required
            ...
            <div className="mb-3">
              <label htmlFor="nombre" className="form-label titulo">
                Nombre
              </label>
              <input
                required
            ...
            <div className="mb-3">
              <label htmlFor="apellidoPaterno" className="form-label titulo">
                Apellido Paterno
              </label>
              <input
                required
            ...
            <div className="mb-3">
              <label htmlFor="apellidoMaterno" className="form-label titulo">
                Apellido Materno
              </label>
              <input
                required
            ...
            <div className="mb-3">
              <label htmlFor="telefono" className="form-label titulo">
                Telefono
              </label>
              <input
                required
            ...
            <div className="mb-3">
              <label htmlFor="correo" className="form-label titulo">
                Correo
              </label>
              <input
                required
            ...
            <div className="mb-3">
              <label htmlFor="carrera" className="form-label titulo">
                Carrera
              </label>
              <select
                required
              ...
              >
                ...
                <option value="Desarrollo de Negocios Área Mercadotecnia">
                  Desarrollo de Negocios Área Mercadotecnia
                </option>
                <option value="Diseño Digital Área Animación">
                  Diseño Digital Área Animación
                </option>
                <option value="Energías Renovables Área Calidad y Ahorro De Energía">
                  Energías Renovables Área Calidad y Ahorro De Energía
                </option>
                <option value="Lengua Inglesa">Lengua Inglesa</option>
                <option value="Mantenimiento Área Industrial">
                  Mantenimiento Área Industrial
                </option>
                <option value="Mecatrónica Area Sistemas de Manufactura Flexible">
                  Mecatrónica Area Sistemas de Manufactura Flexible
                </option>
                <option value="Operaciones Comerciales Internacionales Área Clasificación Arancelaria y Despacho Aduanero">
                  Operaciones Comerciales Internacionales Área Clasificación
                  Arancelaria y Despacho Aduanero
                </option>
                <option value="Procesos Industriales Área Manufactura">
                  Procesos Industriales Área Manufactura
                </option>
                <option value="Tecnologías de la Información">
                  Tecnologías de la Información
                </option>
                <option value="Ing en desarrollo y gestión de software">
                  Ing en desarrollo y gestión de software
                </option>
                <option value="Ing en energías renovables">
                  Ing en energías renovables
                </option>
                <option value="Ing en logística internacional">
                  Ing en logística internacional
                </option>
                <option value="Ing en mantenimiento industrial">
                  Ing en mantenimiento industrial
                </option>
                <option value="Ing en mecatrónica">Ing en mecatrónica</option>
                <option value="Lic en gestión institucional, educativa y curricular">
                  Lic en gestión institucional, educativa y curricular
                </option>
                <option value="Lic en innovación de negocios y mercadotecnia">
