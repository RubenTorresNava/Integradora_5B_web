...
const FormularioPrestamoAlumno = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <h2 className="titulo">Datos del Libro</h2>
            <div className="row">
                <div className="col">
            ...
            <h2 className="titulo">Datos del Préstamo</h2>
            <div className="row">
                <div className="col">
            ...
            <h2 className="titulo">Datos del Empleado</h2>
            <div className="row">
                <div className="col">
            ...
            <select required name="tipoPrestamo" className="form-control mb-3" value={datosPrestamo.tipoPrestamo} onChange={handleChangePrestamo}>
                <option value="">Selecciona el tipo de préstamo</option>
                <option value="normal">Préstamo normal</option>
                <option value="tiempo">Préstamo por tiempo</option>
            </select>
            <div className="d-grid gap-2">
                <button type="submit" className="btn btn-success" disabled={!Object.values(datosPrestamo).every(Boolean)}>Enviar</button>
            </div>
        </form>
    );
};
